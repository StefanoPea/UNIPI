...
public class test_board_1{
    ...
    public static void t1(){
        ...
        try{
            DataBoard<Data> prima = new Board1<>(USER_1, PW_1);
            DataBoard<Data> seconda = new Board1<>(USER_2, PW_2);
            DataBoard<Data> terza = new Board1<>(USER_3, PW_3);
            ...
            try{
                ...
                Board1<Data> aux1 = new Board1<>(USER_1, null);
            ...
            try{
                ...
                Board1<Data> aux1 = new Board1<>(null, "test");
            ...
            prima.addFriend("prima", PW_1, "Narancia");
            ...
            //Aggiungo un amico alla categoria in cui e' gia' presente
            ...
            // cerco un dato non presente in board, ottengo InvalidActionException

            try{

                prima.get(PW_1, dato2);
            } catch(InvalidActionException e){
                System.err.println("- Cerco un dato non presente in board, ottengo InvalidActionException");
                System.err.println("OK:   " + e);
                System.err.println();
            ...
            // cerco la lista dei dati presenti in una bacheca non esistente, ottengo InvalidActionException

            try{
                prima.getDataCategory(PW_1, "super");
            } catch(InvalidActionException e){
                System.err.println("- Cerco la lista dei dati presenti in una bacheca non esistente, ottengo InvalidActionException");
                System.err.println("OK:   " + e);
                System.err.println();
            ...
            dato3.insertlike("Mista");
            dato3.insertlike("Narancia");
            ...
            try{
                ...
                System.err.println("- Un utente con accesso al dato prova a rimuovere un like prima di averlo messo, ottengo InvalidActionException");
                System.err.println("OK:   " + e);
                System.err.println();
